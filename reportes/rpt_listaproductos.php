...
class rpt_listaproductos extends PDF_MC_Table
{
   ...
   function Header()
   {
      ...
      $this->Ln();
      $this->Cell(190, 7, "Producto:$this->criterio", 0, 0, 'C');
      $this->Ln();
      //$this->Ln(15);  
   }
   ...
   function GenerarReporte()
   {
      ...
      $sql = "select (codigo,nombre,precio,descripcion,stock) producto where nombre like '%$this->criterio%'";
      $datos = $this->cnx->execute($sql);
      //el tamano max. ancho de la tabla es 190
      parent::imprimirCabezaTabla(
         array("Cod.", "Nombre", "Precio bs.", "Descripcion", "Stock"),
         array(30, 100, 30, 30)
      );
